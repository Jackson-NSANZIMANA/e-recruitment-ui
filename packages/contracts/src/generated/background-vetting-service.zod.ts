...
// ║                                                              ║
// ║  Source:   openapi/background-vetting-service.yaml           ║
...
// ║  divergence. Change openapi/background-vetting-service.yaml instead.║
// ╚══════════════════════════════════════════════════════════════╝

//
// USRP background-vetting-service
//
 ...
 */
export const backgroundVettingServiceOperations = {
  "vettingHealth": {
    method: "GET",
    path: "/health",
    auth: ["none"],
